...
timerContainer.style.marginTop = '50px';
timerContainer.style.display = 'flex';
timerContainer.style.gap = '50px';
timerContainer.style.justifyContent = 'center';

for (let i = 0; i < field.length; i++) {
  field[i].style.border = '5px outset red';
  field[i].style.backgroundColor = 'gold';
  field[i].style.padding = '10px';
  fieldLabel[i].style.textTransform = 'uppercase';
  fieldValue[i].style.fontSize = '40px';
}
